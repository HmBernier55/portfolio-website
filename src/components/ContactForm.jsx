    ...
    <div className='xl:w-[35%] flex'>
      {!confirmation &&
        <form ref={form} onSubmit={sendEmail} className='flex flex-col gap-8 w-full'>
          <input
            className='h-10 bg-transparent border-b border-custom-gray outline-0 text-white indent-4 focus:border-custom-green'
            type="text"
            name="user_name"
            placeholder='NAME'
            required
          ...
          />
          <textarea
            className='h-28 bg-transparent border-b border-custom-gray outline-0 text-white indent-4 focus:border-custom-green'
            name="message"
            placeholder='MESSAGE'
            required
          />
