  ...
  return (
    <div className='flex flex-col gap-20 xl:flex-row items-center justify-between mb-28'>
      <div className='flex flex-col gap-11 xl:max-w-[50%] order-2 xl:order-1'>
        ...
        <a
          className='w-fit self-center xl:self-start text-white font-bold tracking-[2px] border-b-2 border-custom-green py-2 transition ease-in-out duration-300 hover:text-custom-green hover:scale-110'
          href={Resume}
